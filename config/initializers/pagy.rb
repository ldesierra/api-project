...
# The :params can be also set as a lambda e.g ->(params){ params.exclude('useless')
# .merge!('custom' => 'useful') }
...
# Metadata extra: Provides the pagination metadata to Javascript frameworks like Vue.js,
# react.js, etc.
# See https://ddnexus.github.io/pagy/extras/metadata
# you must require the frontend helpers internal extra (BEFORE the metadata extra) ONLY
